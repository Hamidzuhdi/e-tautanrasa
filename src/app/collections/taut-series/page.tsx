// src/app/collections/taut-series/page.tsx
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="bg-gray-50 py-3 px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          <nav className="text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">TAUT SERIES</span>
          </nav>
        </div>
      </div>
      ...
      <section className="py-8 md:py-12 px-4 md:px-6 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4 text-gray-900">TAUT SERIES</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            Rangkaian fashion yang terhubung harmonis. Koleksi yang dirancang untuk memberikan keseimbangan sempurna antara kenyamanan dan gaya.
          </p>
        </div>
      </section>
